...
public class PlayerStateManager : ObjectStateManager
{
    ...
    void Start()
    {
        ...
        objectFSM.CreateState("Death", (FSM_Player_Death_Enter,
                                null,
                                FSM_Player_Death_Update,
                                null,
                                FSM_Player_Death_Exit));
    ...
    void FSM_Player_Run_Enter()
    {
        ...
        playerMovement.SetFlip(xAxis);
        playerEffectManagerClass.PlayRunCloudEffect();
    ...
    {
        playerEffectManagerClass.StopCurrentRunCloudEffect();
    }
    ...
    void FSM_Player_Attack_Enter()
    {
        ...
        playerMovement.SetFlip(mousePos.x - transform.position.x);
    ...
    void FSM_Player_Death_Enter()
    {
        playerState = PlayerState.Death;
        ccollider.radius = 0.12f;
       
    }
    void FSM_Player_Death_Update(StateInfo _info)
    {

    }
    void FSM_Player_Death_Exit(StateInfo _info)
    {
        playerSwardClass.gameObject.SetActive(false);
    }
